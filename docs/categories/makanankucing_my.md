...
| Field | Value |
|-------|-------|
| LLM Pass | ✅ Complete (Full Rebuild, first run) + 🔶 Top-up coverage pass (2026-07-23) + 🔶 second top-up coverage pass (2026-07-23) + 🔶 third top-up coverage pass (2026-07-28, Tiktok scope added) + 🔶 fourth top-up coverage pass (2026-07-28) + 🔶 fifth top-up coverage pass (2026-07-28, this session, partial — 286 products still gap) |
| GMV Coverage | 86.4% as of Full Rebuild; see prior QA History rows for the 2026-07-23 and third-top-up (2026-07-28) sessions. Fourth top-up's live worklist was 398 products (all Tiktok), resolved 101. This session's live worklist was 297 (all Tiktok), resolved 11 |
| Last run | 2026-07-28 (fifth top-up coverage session, this session) |
| Current MAX taxonomy_id (this category) | SKU-193346 |
| SKU blocks this category has claimed | SKU-145586–147585 (Full Rebuild, 1,554 used) · SKU-155023–155717 (top-up 1, 77 used) · SKU-157403–157956 (top-up 2, 53 used) · SKU-191043–192543 (top-up 3, 151 used) · SKU-192544–192941 (top-up 4, 63 used) · SKU-193342–193361 (top-up 5, this session, 5 used) |
...
| SKU-193342–SKU-193361 | Claimed block (20 slots, `sku_block_registry`, scenario `custom_topup`, 2026-07-28, fifth top-up, this session — see QA History for why this block isn't a round 297/200/2000; the registry's own missing-row bug meant the naive 297-slot claim collided with fourth top-up's already-written range) |
...
## Map Row Counts (as of the fifth top-up session, 2026-07-28, this session)

| Source | Count | Notes |
|--------|-------|-------|
| LLM | 3,253 | 1,832 Full Rebuild + 141 first top-up + 65 second top-up + 1,103 third top-up + 101 fourth top-up + 11 this session (all Tiktok — image-led resolution of the text-exhausted residue, see QA History) |
| HUMAN | 0 | No prior keyword-seed pass for this category |
| NULL (unmapped, in-scope, live-worklist gap remaining) | 286 | See this session's QA History rows for the resolved/excluded breakdown — live worklist re-run post-write confirms 286 (297 − 11) exactly |
| NULL (out-of-scope, correctly excluded, this session's live worklist) | not assessed this session | **Correction:** an earlier edit to this row incorrectly claimed the STEP-0 query filters out OOS rows — it does not; STEP-0 only filters on `cumulative_gmv_pct <= 95 AND canonical_name IS NULL`, with no scope classifier at all. This session went image-led on the brand-matched-but-size-unresolved tail and never ran an in-scope/OOS classification pass over the 182 brand-unmatched rows, unlike every prior session. The 286 remaining is an unclassified mix of in-scope and possibly-OOS rows — a future session needs to run the scope classifier before trusting any "in-scope gap" figure for this table |
