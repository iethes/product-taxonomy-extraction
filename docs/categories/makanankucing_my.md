...
| Field | Value |
|-------|-------|
| LLM Pass | ✅ Complete (Full Rebuild, first run) + 🔶 Top-up coverage pass (2026-07-23) + 🔶 second top-up coverage pass (2026-07-23) + 🔶 third top-up coverage pass (2026-07-28, Tiktok scope added) + 🔶 fourth top-up coverage pass (2026-07-28, this session, partial — 297 products still gap) |
| GMV Coverage | 86.4% as of Full Rebuild; see prior QA History rows for the 2026-07-23 and third-top-up (2026-07-28) sessions. This session's live worklist was 398 products (all Tiktok), resolved 101 |
| Last run | 2026-07-28 (fourth top-up coverage session, this session) |
| Current MAX taxonomy_id (this category) | SKU-192606 |
| SKU blocks this category has claimed | SKU-145586–147585 (Full Rebuild, 1,554 used) · SKU-155023–155717 (top-up 1, 77 used) · SKU-157403–157956 (top-up 2, 53 used) · SKU-191043–192543 (top-up 3, 151 used) · SKU-192544–192941 (top-up 4, this session, 63 used) |
...
## Map Row Counts (as of the fourth top-up session, 2026-07-28, this session)

| Source | Count | Notes |
|--------|-------|-------|
| LLM | 3,242 | 1,832 Full Rebuild + 141 first top-up + 65 second top-up + 1,103 third top-up + 101 this session (all Tiktok — bulk regex text-matching against sku_name, no image reads this session) |
| HUMAN | 0 | No prior keyword-seed pass for this category |
| NULL (unmapped, in-scope, live-worklist gap remaining) | 297 | Roughly 126 brand-unidentifiable-from-text + 165 brand-matched-but-size-unresolved + a handful excluded on ambiguity grounds (see QA History) — live worklist re-run post-write confirms 297 (398 − 101) exactly |
| NULL (out-of-scope, correctly excluded, this session's live worklist) | 2 | 1 livestock/plant feed (molasses), 1 cat litter |
