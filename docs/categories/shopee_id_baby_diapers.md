...
| GMV Coverage | 98.18% product-level GWP-zeroed (month 2026-06), up from 96.85% |
| Last run | 2026-07-20 (second top-up session) |
| Current MAX taxonomy_id (registry floor at session start) | SKU-096540 (second top-up session reused unused remainder of the supplemental block, SKU-096541–096557) |
...
| SKU-096558–096961 | Remaining unused remainder of the supplemental block — still `ACTIVE`, safe to reuse for a future QA/gap-fill pass on this category |
