...
| GMV Coverage | 96.85% product-level GWP-zeroed (month 2026-06), up from 91.93% |
| Last run | 2026-07-20 (top-up session) |
| Current MAX taxonomy_id (registry floor at session start) | SKU-093441 (top-up session reused unused remainder of the supplemental block, SKU-096476–096540) |
...
| SKU-096541–096961 | Remaining unused remainder of the supplemental block — still `ACTIVE`, safe to reuse for a future QA/gap-fill pass on this category |
